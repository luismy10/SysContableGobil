...
class RepLibroMayor extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            fechaIni: '',
                ...
                <div className="row">
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className="form-group">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Libro Mayor
                            ...
                            <table className="table table-striped table-bordered rounded">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="py-1 text-center" colSpan={2}>Saldo Inicial</th>
                                        <th className="py-1 text-center" colSpan={2}>Movimientos</th>
                                        <th className="py-1 text-center" colSpan={2}>Saldo final</th>
                                    </tr>
                                    <tr>
