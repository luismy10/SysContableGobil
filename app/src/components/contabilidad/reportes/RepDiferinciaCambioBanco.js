...
class RepDiferinciaCambioBanco extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            fechaIni: '',
                ...
                <div className="row">
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className="form-group">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Diferencia en cambio de bancos
                            ...
                            <table className="table table-striped table-bordered rounded">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%">N° de cuenta</th>
                                        <th width="10%">Moneda</th>
                                        <th width="30%">Observaciones</th>
                                        <th width="15%">Ganancia/Perdida</th>
...
export default RepDiferinciaCambioBanco;