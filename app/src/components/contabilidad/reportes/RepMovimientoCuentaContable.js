...
class RepMovimientoCuentaContable extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            fechaIni: '',
            ...
            <>
                <div className="row">
                    <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div className="form-group">
                            <h5>
                                <span role="button" onClick={() => this.props.history.goBack()}><i className="bi bi-arrow-left-short"></i></span> Movimientos por cuenta contable
                ...
                <div className="row">
                    ...
                    <div className="col">
                        ...
                        <div className="form-group">
                            <span>Cuenta <i className="fa fa-asterisk text-danger small"></i></span>
                            <div className="input-group input-group-sm">
...
export default RepMovimientoCuentaContable