...
class SearchBarConceptos extends React.Component {
  constructor(props) {
    super(props);
    this.index = -1;
  }
        ...
        <div className="form-group position-relative mb-0">
          <div className="input-group input-group-sm">
            <input
              ...
              ref={this.props.refConcepto}
              value={this.props.nombreConcepto}
            ...
            <div className="input-group-append">
              <button
                ...
                onClick={() => {
                  this.props.onEventClearInput();
                  this.props.refConcepto.current.focus();
                  this.index = -1;
                }}
              >
          ...
          {this.props.filteredData.length !== 0 && (
            ...
            >
              {this.props.filteredData.map((value, index) => (
                ...
                >
                  {`${value.codigo} - ${value.nombreConcepto}`}
                </button>
              ))}
            </div>
          )}
...
export default SearchBarConceptos;
