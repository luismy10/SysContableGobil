                            ...
                            <table className="table table-striped table-bordered rounded">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%" className="p-1">Descripción</th>
                                        <th width="10%" className="p-1">Medida</th>
                                ...
                                <tbody>
                                    {
                                        this.state.loading ? (
                                            <tr>
                                                <td className="text-center p-1" colSpan="9">
                                                    {spinnerLoading()}
                                                </td>
                                            </tr>
                                        ) : this.state.lista.length === 0 ? (
                                            <tr className="text-center">
                                                <td className="p-1" colSpan="9">¡No hay datos registrados!</td>
                                            </tr>
                                        ) : null
